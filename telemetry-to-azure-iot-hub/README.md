...
1. For the certificate, click on *Select file* and browse to `cert/` and select `<device identity name>.crt`
1. For the private key, click on *Select file* and browse to `cert/` and select `<device identity name>.key`
1. Click on *Install*
